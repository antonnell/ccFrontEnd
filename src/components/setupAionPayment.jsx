...
class SetupAionPayment extends Component {
  renderAddresses(accountValue, error, errorMessage, onChange, type) {
    if (
      this.props.aionAddresses == null ||
      this.props.aionAddresses.length === 0
    ) {
      return (
            ...
            return (
              <MenuItem value={address.address} key={address.address}>
                ...
                <ListItemSecondaryAction style={{ right: "24px" }}>
                  <Typography>{address.balance + " AION"}</Typography>
      ...
      <FormControl error style={{ minWidth: "300px", width: "100%" }}>
        ...
        >
          {this.props.contacts.map(contact => {
            return (
              <MenuItem
                value={contact.primaryAionAddress}
                key={contact.primaryAionAddress}
              >
                <ListItemText
                  primary={contact.displayName}
                  secondary={contact.primaryAionAddress}
                />
              </MenuItem>
            );
          })}
        ...
        >
          ...
          <Grid item xs={12} align="left" style={{ marginTop: "24px" }}>
            ...
            <TextField
              ...
              InputProps={{
                endAdornment: (
                  <InputAdornment position="end">Aion</InputAdornment>
                )
              }}
            />
          </Grid>
