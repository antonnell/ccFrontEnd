...
function ContactIcon(props) {
  ...
  return (
    <SvgIcon {...excludingColor}>
      <path fill={color} d="M12,19.2C9.5,19.2 7.29,17.92 6,16C6.03,14 10,12.9 12,12.9C14,12.9 17.97,14 18,16C16.71,17.92 14.5,19.2 12,19.2M12,5A3,3 0 0,1 15,8A3,3 0 0,1 12,11A3,3 0 0,1 9,8A3,3 0 0,1 12,5M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12C22,6.47 17.5,2 12,2Z" />
    </SvgIcon>
  );
}
...
function LogoutIcon(props) {
  ...
  return (
    <SvgIcon {...excludingColor}>
      <path fill={color} d="M17,17.25V14H10V10H17V6.75L22.25,12L17,17.25M13,2A2,2 0 0,1 15,4V8H13V4H4V20H13V16H15V20A2,2 0 0,1 13,22H4A2,2 0 0,1 2,20V4A2,2 0 0,1 4,2H13Z" />
    </SvgIcon>
  );
}
function PoolingIcon(props) {
  ...
  return (
    <SvgIcon {...excludingColor}>
      <path fill={color} d="M16,13C15.71,13 15.38,13 15.03,13.05C16.19,13.89 17,15 17,16.5V19H23V16.5C23,14.17 18.33,13 16,13M8,13C5.67,13 1,14.17 1,16.5V19H15V16.5C15,14.17 10.33,13 8,13M8,11A3,3 0 0,0 11,8A3,3 0 0,0 8,5A3,3 0 0,0 5,8A3,3 0 0,0 8,11M16,11A3,3 0 0,0 19,8A3,3 0 0,0 16,5A3,3 0 0,0 13,8A3,3 0 0,0 16,11Z" />
    </SvgIcon>
  )
}
function IcoIcon(props) {
  ...
  return (
    <SvgIcon {...excludingColor}>
      <path fill={color} d="M9.29,21H12.12L21,12.12V9.29M19,21C19.55,21 20.05,20.78 20.41,20.41C20.78,20.05 21,19.55 21,19V17L17,21M5,3A2,2 0 0,0 3,5V7L7,3M11.88,3L3,11.88V14.71L14.71,3M19.5,3.08L3.08,19.5C3.17,19.85 3.35,20.16 3.59,20.41C3.84,20.65 4.15,20.83 4.5,20.92L20.93,4.5C20.74,3.8 20.2,3.26 19.5,3.08Z" />
    </SvgIcon>
  )
}
  ...
  renderTop() {
    if(this.props.theme.name == 'dark') {
      return (<Card style={{height: '210px', padding: '24px', position: 'relative', marginBottom: '8px'}} >
        ...
        <Typography variant="subtitle1" style={{position: 'absolute', bottom: '22px', fontSize: '30px'}}>
          {this.props.user.username}
        </Typography>
        <Typography variant="subtitle1" style={{position: 'absolute', bottom: '12px'}}>
