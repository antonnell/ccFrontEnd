...
// function EthIconPng() {
//   return (
//     <div style={ { marginLeft: '4px', marginRight: '4px', overflow: 'hidden' } }>
//       <img
//         alt=""
  ...
  renderList() {
    ...
    return (
      <List style={ { height: "calc(100% - 163px)" } }>
        ...
        <ListItem
          selected={ currentScreen === 'aionAccounts' || currentScreen === 'sendAion' }
          button
          onClick={ event => {
        ...
        <ListItem
          selected={ currentScreen === 'bitcoinAccounts' || currentScreen === 'sendBitcoin' }
          button
          onClick={ event => {
        ...
        <ListItem
          selected={ currentScreen === 'ethAccounts' || currentScreen === 'sendEthereum' || currentScreen === 'sendERC20' }
          button
          onClick={ event => {
        ...
        <ListItem
          selected={ currentScreen === 'wanAccounts' || currentScreen === 'sendWanchain' || currentScreen === 'sendWRC20' }
          button
          onClick={ event => {
        ...
        <ListItem
          selected={ currentScreen === 'sendAion' }
          button
          onClick={ event => {
            navClicked(event, 'sendAion');
          } }
        >
          <ListItemText primary="Send Aion" />
        </ListItem>
        <ListItem
          selected={ currentScreen === 'sendBitcoin' }
          button
          onClick={ event => {
            navClicked(event, 'sendBitcoin');
          } }
        >
          <ListItemText primary="Send BTC" />
        </ListItem>
        <ListItem
          selected={ currentScreen === 'sendEthereum' }
          button
          onClick={ event => {
            navClicked(event, 'sendEthereum');
          } }
        >
          <ListItemText primary="Send Eth" />
        </ListItem>
        <ListItem
          selected={ currentScreen === 'sendERC20' }
          button
          onClick={ event => {
            navClicked(event, 'sendERC20');
          } }
        >
          <ListItemText primary="Send ERC20" />
        </ListItem>
        <ListItem
          selected={ currentScreen === 'sendWanchain' }
          button
          onClick={ event => {
            navClicked(event, 'sendWanchain');
          } }
        >
          <ListItemText primary="Send Wan" />
        </ListItem>
        <ListItem
          selected={ currentScreen === 'sendWRC20' }
          button
          onClick={ event => {
            navClicked(event, 'sendWRC20');
          } }
        >
        ...
        <ListItem
          selected={ currentScreen === 'browsePools' }
          button
          onClick={ event => {
