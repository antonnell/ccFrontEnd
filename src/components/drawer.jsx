...
class AppDrawer extends Component {
  ...
  render() {
    ...
    return this.props.size === 'xs' || this.props.size === 'sm' ? (
      <Drawer
    ...
    return (
      <List>
        ...
        <ListItem
          ...
          button
          onClick={ event => {
            this.props.navClicked(event, 'aionAccounts');
          } }
        >
          <ListItemIcon>
            <AionIconPng />
        ...
        <ListItem
          ...
          button
          onClick={ event => {
            this.props.navClicked(event, 'ethAccounts');
          } }
        >
          <ListItemIcon>
            <EthIconPng />
        ...
        <ListItem
          selected={ this.props.currentScreen === 'wanAccounts' }
          button
          onClick={ event => {
            this.props.navClicked(event, 'wanAccounts');
          } }
        >
          <ListItemIcon>
            <WanIconPng />
        ...
        <ListItem
          ...
          button
          onClick={ event => {
            this.props.navClicked(event, 'sendAion');
          } }
        >
          <ListItemIcon>
            <AionIconPng />
        ...
        <ListItem
          ...
          button
          onClick={ event => {
            this.props.navClicked(event, 'sendEthereum');
          } }
        >
          <ListItemIcon>
            <EthIconPng />
        ...
        <ListItem
          selected={ this.props.currentScreen === 'sendERC20' }
          button
          onClick={ event => {
            this.props.navClicked(event, 'sendERC20');
          } }
        >
          <ListItemIcon>
            <EthIconPng />
        ...
        <ListItem
          selected={ this.props.currentScreen === 'sendWanchain' }
          button
          onClick={ event => {
            this.props.navClicked(event, 'sendWanchain');
          } }
        >
          <ListItemIcon>
            <WanIconPng />
        ...
        <ListItem
          ...
          button
          onClick={ event => {
            this.props.navClicked(event, 'contacts');
          } }
        >
          <ListItemIcon>
        ...
        <ListItem
          selected={ this.props.currentScreen === 'settings' }
          button
          onClick={ event => {
            this.props.navClicked(event, 'settings');
          } }
        >
          <ListItemIcon>
        ...
        <ListItem
          button
          onClick={ event => {
            this.props.navClicked(event, 'logOut');
          } }
        >
          <ListItemIcon>
