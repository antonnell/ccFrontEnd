        ...
        <Grid item xs={10} sm={6} md={4} lg={3}>
          ...
          >
            <Grid item xs={12} align="center">
              <Typography variant="h5">Add me to the whitelist</Typography>
            </Grid>
          </Grid>
          <Grid
            container
          ...
          >
            <Grid item xs={12} style={{ marginTop: "50px" }}>
              <TextField
                ...
                onKeyDown={this.props.onWhitelistKeyDown}
                onChange={event => {
              ...
              <TextField
                ...
                margin="normal"
                helperText={this.props.firstnameErrorMessage}
              />
              <TextField
                required
                fullWidth={true}
                color="textSecondary"
                error={this.props.surnameError}
                disabled={this.props.loading}
                id="surname"
                label="Surname"
                ...
                onKeyDown={this.props.onWhitelistKeyDown}
                onChange={event => {
                  this.props.handleChange(event, "surname");
                }}
                margin="normal"
                helperText={this.props.surnameErrorMessage}
              />
              <TextField
                fullWidth={true}
                color="textSecondary"
                error={this.props.telegramError}
                disabled={this.props.loading}
                id="telegram"
                ...
                onKeyDown={this.props.onWhitelistKeyDown}
                onChange={event => {
                  this.props.handleChange(event, "telegram");
                }}
                margin="normal"
                helperText={this.props.telegramErrorMessage}
              />
              <FormControl
                fullWidth={true}
                margin="normal"
              ...
              >
                ...
                <Select
                  ...
                  onChange={event => {
                    this.props.handleChange(event, "country");
                  }}
                  inputProps={{
                    name: "country",
                    id: "country-simple"
                ...
                <FormHelperText>
                  {this.props.countryErrorMessage}
                </FormHelperText>
              </FormControl>
              <FormControl
                component="accepted"
              ...
              >
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={event => {
                        this.props.handleChecked(event, "accepted");
                      }}
                      value="accepted"
                    />
                  }
                ...
                />
                <FormHelperText>
                  {this.props.acceptedErrorMessage}
                </FormHelperText>
              </FormControl>
            </Grid>
          </Grid>
          ...
          >
            <Grid item xs={12} align="right">
              <Button
                ...
                size="large"
                color="primary"
                onClick={this.props.submitWhitelist}
                disabled={this.props.loading}
              >
                Whitelist
              </Button>
