          ...
          <Grid container justify="flex-start" alignItems="flex-start" direction="row" spacing={0}>
            <Grid item xs={12} align='center'>
              <Typography variant="display1">
                What would you like to name your Wanchain address?
              </Typography>
            </Grid>
            <Grid item xs={12} align='center'>
            ...
            <Grid item xs={6} align='left' style={{marginTop: '24px '}}>
              <Button size="small" variant="flat" onClick={this.props.navigateImportWanAddress}>I'd like to import one</Button>
            </Grid>
            <Grid item xs={6} align='right' style={{marginTop: '24px '}}>
              <Button size="small" variant="flat" color="secondary" onClick={this.props.createWanAddress}>Make address</Button>
            </Grid>
          </Grid>
        </CardContent>
      </Card>
