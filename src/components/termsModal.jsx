  ...
  render() {
    return (
      <Dialog open={this.props.isOpen} title="Terms & Conditions" onClose={this.props.handleClose} fullWidth={true} maxWidth={'lg'} TransitionComponent={Transition}>
            ...
            { () => <div>
              <Typography variant='body1'>
                <p>
                  ...
                  PURCHASING, OWNING, AND USING CURV TOKENS FOR THE PROVISION OR RECEIPT OF
                  SERVICES IN THE ECOSYSTEM (AS DISCLOSED AND EXPLAINED IN EXHIBIT A) AND
                  THAT SECTION 18 CONTAINS A BINDING ARBITRATION CLAUSE AND CLASS ACTION
                  WAIVER, WHICH AFFECT YOUR LEGAL RIGHTS. IF YOU DO NOT AGREE TO THESE TERMS,
                  DO NOT PURCHASE TOKENS.
                </p>
                <p>
                  Your purchase of CURV tokens (“<strong>Tokens</strong>”) during the Sale
                  (as defined below) from Stichting CryptoCurve, a Dutch foundation (the “<strong>Company</strong>,” “<strong>we</strong>,” or “<strong>us</strong>”), is subject to these terms of sale (“<strong>Terms</strong>”) and these
                  Terms form part of the agreement(s) you enter into with the Company in
                  connection with such purpose. By purchasing Tokens from us during the Sale,
                  you will be bound by these Terms and any terms incorporated by reference.
                  Each of you and the Company is a “<strong>Party</strong>” and, together,
                  the “<strong>Parties</strong>.” If you have any questions regarding these
                  Terms, please contact us prior to participating in the Sale at:
                ...
                <ol style={{paddingLeft: '0px'}}>
                  <li>
                      ...
                      private sale. The public sale of Tokens (the “<strong>Sale</strong>”)
                      shall take place on June 30, 2018 and end in 30 days or when 30,000,000
                      Tokens have been sold, whichever is first. The Company will also
                  conduct a private sale of Tokens which begun on May 31, 2018 (the “        <strong>Private Sale</strong>”). In connection with the Private Sale,
                      the Company has entered into and may enter into Simple Agreements for
                      Future Tokens (“<strong>SAFTs</strong>”) with one or more persons. The
                      Private Sale will end when 130,000,000 Tokens (or rights to Tokens
                      pursuant to SAFTs) have been sold. Bonus Tokens to which purchasers of
                  ...
                  <li>
                      ...
                      information (your “<strong>User Credentials</strong>”) against their
                      database of people ineligible to purchase Tokens or other
                      cryptocurrency tokens. You must also have a Wanchain wallet that
                      supports the Token standard in order to receive any Tokens you purchase
              from us and provide the address for that wallet (the “        <strong>Token Receipt Address</strong>”) or you may create one using
                      our Sale Portal. We will not be held liable if you misplace your
                      private key for the wallet created on our Sale Portal, submit an
                      address from an exchange wallet such as coinbase.com or binance.com
                      which does not provide you with the private key for Token access, or
                      provide us with an incorrect<strong> </strong>Token Receipt Address or
                      a Token Receipt Address of which a person other than you owns the
                      private key. We reserve the right to (i) make your eligibility to
                      participate in the Sale and to log into the Sale Portal to make a
                      purchase subject to the provision by you of further (personal)
                      information, whether or not as a result of the Know Your Customer and
                      Anti-Money Laundering Compliance checks performed by Netki and
                  ...
                  <li>
                      ...
                      <ol type='a'>
                        <li>
                          <p>
                            <u>Price; Payment Currencies</u>. The USD price equivalent per Token (“<strong>Price Per Token</strong>”) is set forth on our website
                            www.cryptocurve.io (the “<strong>Website</strong>”) and Sale Portal at
                            cryptocurve.network (the “<strong>Sale Portal</strong>”). Tokens may be
                            purchased with Ethereum (“<strong>ETH</strong>”) or Wanchain (“    <strong>WAN</strong>”) (collectively, “<strong>Blockchain Tokens</strong>”
                            or “<strong>BCTs</strong>”) depending on the round of sale as set forth on
                            the Website.
                          </p>
                        </li>
                        <li>
                          <p>
                            <u>Purchase Procedure</u>. After logging into the Sale Portal via the
                            Website, you will be prompted to select the amount of BCT you wish to
                            allocate toward your purchase of Tokens (or SAFTs convertible to Token
                            where applicable). We reserve the right, in our sole discretion, to modify
                            any of the procedures described herein to account for network congestion or
                            other technical challenges.
                          </p>
                        </li>
                        <li>
                          <p>
                              <u>Purchase Price</u>. Your quoted “<strong>Purchase Price</strong>” in
                              the selected BCTs is equal to the USD value of the Token shown as your
                              purchase amount on the Sale Portal divided by the Exchange Rate (as defined
                              below). The “<strong>Exchange Rate</strong>” will be the exchange rate
                              between BCTs and USD as determined and published by the Company on the
                              Website ahead of each Sale. The Company will determine each relevant
                              Exchange Rate at its discretion and publish such Exchange Rate to the
                              Website in advance of each round of sale. The Company shall not be liable
                              towards you or any other person in connection with the determination of
                              Exchange Rates, including but not limited to the event that an Exchange
                              Rate is not equal to the rate that in your or in anyone’s opinion is to be
                              regarded as the relevant leading market rate.
                          </p>
                        </li>
                        <li>
                          <p>
                            <u>Purchase Price Must Be Received in Full Upon Purchase</u>. Payment
                            ...
                            (i) make your purchase and the release to you of Tokens subject to the
                            provision by you of further (personal) information, whether or not as a
                            result of the Know Your Customer and Anti-Money Laundering Compliance
                            checks performed by Netki and ComplyAdvantage, and (ii) modify any of the
                            timelines described herein to account for network congestion or other
                            technical challenges.
                          </p>
                        </li>
                        <li>
                          <p>
                            <u>Payment of Purchase Price</u>. You must pay the Purchase Price by
                        ...
                        <li>
                          <p>
                            <u>User Information and Limits</u>. You agree that all information
                            provided to the Company, via the Website, the Sale Portal or otherwise, is
                            accurate. You alone are responsible for any acts or omissions that occur
                            during the Sale through the use of your User Credentials. We reserve the
                            right to suspend or block your access to the Sale upon suspicion of any
                            unauthorized access or use, or any attempt thereof, by anyone associated
                            with your User Credentials.
                          </p>
                        </li>
                        <li>
                          <p>
                            <u>Delivery of Tokens</u>. The Company shall deliver the purchased
                            Tokens to you within seven (7) days of the conclusion of the Sale. The
                            Tokens may be subject to use and/or transfer restrictions in accordance
                            with the lockup terms published by the Company ahead of the Sale (or as
                            otherwise set forth in the SAFTs, if applicable).
                          </p>
                        </li>
                        <li>
                          <p>
                            <u>Country Restrictions</u>. THE TOKENS ARE NOT BEING OFFERED OR SOLD
                            AND MAY NOT BE OFFERED OR SOLD, DIRECTLY OR INDIRECTLY, WITHIN THE <u>UNITED STATES OF AMERICA</u>, <u>CANADA</u> OR <u>THE PEOPLE’S REPUBLIC OF CHINA</u>, OR TO ANY RESIDENT OR HOLDER OF A
                            PASSPORT OF THE UNITED STATES OF AMERICA, CANADA OR THE PEOPLE’S REPUBLIC
                            OF CHINA. THESE TERMS AND ANY AGREEMENT OF WHICH THESE TERMS FORM AN
                            INTEGRAL PART DO NOT IN ANY WAY CONSTITUTE, AND NONE OF THE PROVISIONS
                            THEREOF SHOULD BE READ AS, SUCH AN OFFER. ANY PERSON IN THE UNITED STATES
                            OF AMERICA, CANADA OR THE PEOPLE’S REPUBLIC OF CHINA, OR WITH A PASSPORT OF
                            THE UNITED STATES OF AMERICA, CANADA OR THE PEOPLE’S REPUBLIC OF CHINA
                            SHOULD NOT ACT OR RELY ON THESE TERMS OR ON ANY AGREEMENT OF WHICH THESE
                            TERMS FORM AN INTEGRAL PART OR ANY OF THEIR CONTENTS.
                          </p>
                        </li>
                      </ol>
                  </li>
                  <li>
                      ...
                      <ol type='a'>
                        <li>
                          <p>
                            The purpose of the Token is to provide access to the Company’s
                            cryptocurrency wallet (the “<strong>Ecosystem</strong>”). Additional
                            information about the Ecosystem and the Company can be found in the
                            whitepaper available on the Website (the “<strong>Whitepaper</strong>”).
                          </p>
                        </li>
                        <li>
                          <p>
                            Purchase, ownership, receipt, or possession of Tokens carries no
                            ...
                            form of participation in or relating to the Ecosystem and/or the Company
                            and its corporate affiliates, other than any rights relating to use of the
                            Ecosystem, subject to these Terms. The Tokens are not intended to be a
                            (digital) currency (in the sense of legal tender), security (including but
                            not limited to a security (<em>effect</em>) in the meaning of the Dutch
                            Financial Supervision Act (<em>Wet op het financieel toezicht</em>; the “    <strong>FSA</strong>”)), commodity, or any kind of financial instrument
                            (including but not limited to a financial instrument (    <em>financieel instrument</em>) in the meaning of the FSA).
                          </p>
                        </li>
                        <p>
                        ...
                        <li>
                          <p>
                              The Tokens are being created on the Wanchain protocol. We reserve the
                              right to migrate the Wanchain protocol Tokens (the “    <strong>Pre-existing Tokens</strong>”) to another protocol and to generate
                              replacement Tokens on the new protocol (the “    <strong>Replacement Tokens</strong>”) in the future, should we determine,
                              in our sole discretion, that doing so is necessary or useful to the
                              operation of the Ecosystem.
                          </p>
                        </li>
                        <li>
                          <p>
                              Should we decide to migrate the Tokens, we may no longer provide
                              ...
                              the Company does not at this time anticipate that it will require any
                              Pre-existing Token holders to convert their Pre-existing Tokens to
                              Replacement Tokens, the Company anticipates there will be significant
                        ...
                        <li>
                          <p>
                              Should we decide to migrate the Tokens, we will notify you via the
                              email address you provided to us at the time of the Sale, in addition to
                              making announcements regarding the migration on the Website. You are solely
                              responsible for updating us should your contact information change.
                          </p>
                        </li>
                        <li>
                          <p>
                              We may deem it necessary to migrate the tokens to a new smart-contract
                              ...
                              retain the same total token cap and distribution as the prior
                              smart-contract.
                          </p>
                        </li>
                      </ol>
                  ...
                  <li>
                      ...
                      <ol type='a'>
                        <li>
                          <p>
                            Unless otherwise stated herein, these Terms only govern your purchase
                            of Tokens from the Company during the Sale.
                          </p>
                        </li>
                        <li>
                          <p>
                            Any use of Tokens in connection with providing or receiving services in
                  ...
                  <li>
                      ...
                      PURCHASING TOKENS, YOU EXPRESSLY ACKNOWLEDGE AND ASSUME THESE RISKS. As
                      stated above Section 4(b), the Tokens are not, and are not intended to
                      be, a (digital) currency, security, commodity, or any kind of financial
                      instrument, As such, the Tokens and the Sale are not subject to
              regulation under the Dutch Financial Supervision Act (        <em>Wet op het financieel toezicht</em>) or to the supervision of the
              Netherlands Authority for the Financial Markets (        <em>Autoriteit Financiële Markten</em>). You understand and acknowledge
                      that notwithstanding the list of risks set out in Exhibit, these Terms,
                      the Whitepaper or any other information provided to you by the Company
                      do not constitute a prospectus, that these documents do not set out –
                      and do not mean to set out - a complete, detailed or limitative list of
                      risks that are or may be associated with purchasing, owning, and using
                      Tokens. By purchasing Tokens, you expressly acknowledge that you have
                  ...
                  <li>
                    ...
                    . By sending BCTs to purchase Tokens from us, you represent and warrant
                      ...
                      <ol type='a'>
                        <li>
                          <p>
                              You have read and understand these Terms (including all referenced
                              documents);
                          </p>
                        </li>
                        <li>
                          <p>
                              ...
                              TO) THE RISKS DESCRIBED IN EXHIBIT A;
                          </p>
                        </li>
                        <li>
                          <p>
                              You have sufficient understanding of technical and business matters
                        ...
                        <li>
                          <p>
                              You understand the restrictions and risks associated with the creation
                              of Tokens as set forth herein, and acknowledge and assume all such risks;
                          </p>
                        </li>
                        <li>
                          <p>
                              You have obtained sufficient information about the Tokens and the
                              Ecosystem to make an informed decision to purchase Tokens;
                          </p>
                        </li>
                        <li>
                          <p>
                              You understand that the Tokens confer only the right to use the
                        ...
                        <li>
                          <p>
                              You are purchasing Tokens solely for the purpose of utilizing the
                        ...
                        <li>
                          <p>
                              Your obligations under these Terms constitute valid and binding
                              obligations, enforceable against you in accordance with the terms hereof;
                          </p>
                        </li>
                        <li>
                          <p>
                              Your purchase of Tokens complies with applicable laws and regulations
                        ...
                        <li>
                          <p>
                              If you are purchasing Tokens on behalf of any entity, you are
                        ...
                        <li>
                          <p>
                              You are not (i) a citizen or resident of a geographic area in which
                      ...
                      <ol type='a'>
                        <li>
                          <p>
                              ...
                              and assigns (the “<strong>Company Parties</strong>”) from and against all
                        ...
                        <li>
                          <p>
                              Company reserves the right to exercise sole control over the defense,
                  ...
                  <li>
                      ...
                      <ol type='a'>
                        ...
                        <li>
                          <p>
                              THE LIMITATIONS SET FORTH IN SECTION 15(a) WILL NOT LIMIT OR EXCLUDE
                              LIABILITY FOR THE GROSS NEGLIGENCE OR WILLFUL MISCONDUCT OF THE COMPANY.
                          </p>
                        </li>
                        <li>
                          <p>
                  ...
                  <li>
                      ...
                      <ol type='a'>
                        <li>
                          <p>
                              <u>Amicable settlement</u>. Any dispute arising under, out of, or
                              relating to the Tokens, your purchase of the Tokens, the Sale, these Terms
                          ...
                          in writing of a Dispute within thirty (30) days of the date it arises (a “    <strong>Notice</strong>”). Notice to the Company shall be sent by
                              ...
                              basis of the Dispute, and (iii) the specific relief that you are seeking.
                          </p>
                        </li>
                        <li>
                          <p>
                              <u>Binding Arbitration</u>. If the Dispute cannot be amicably settled
                              within thirty (30) days after the date on which the relevant Notice is
                              received by the applicable Party, then the Dispute shall be finally settled
                              by arbitration in accordance with the then prevailing Rules of Conciliation
                              and Arbitration of the International Chamber of Commerce by one or more
                              arbitrators designated in accordance with said rules. The place of
                              arbitration shall be in Amsterdam, the Netherlands. The language to be used
                              in the arbitration proceedings shall be English.
                          </p>
                        </li>
                        <li>
                          <p>
                              <u>No Class Arbitrations, Class Actions or Representative Actions</u>.
        ...
        <DialogActions>
          <Button variant='contained' onClick={this.props.handleTermsAccepted} color="primary" autoFocus>
            Accept
          </Button>
        </DialogActions>
      </Dialog>
