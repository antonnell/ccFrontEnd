...
class SetupEthereumPayment extends Component {
  renderAddresses(accountValue, error, errorMessage, onChange, type) {
    if (
      this.props.ethAddresses == null ||
      this.props.ethAddresses.length === 0
    ) {
      return (
      ...
      <FormControl error style={{ minWidth: "300px", width: "100%" }}>
        <Select
          ...
          renderValue={value => {
            ...
            const selectedAddress = this.props.ethAddresses.filter(address => {
            ...
            return (
              <MenuItem value={address.address} key={address.address}>
                ...
                <ListItemSecondaryAction style={{ right: "24px" }}>
                  <Typography>{address.balance + " ETH"}</Typography>
      ...
      <FormControl error style={{ minWidth: "300px", width: "100%" }}>
        ...
        >
          {this.props.contacts.map(contact => {
            return (
              <MenuItem
                value={contact.primaryEthAddress}
                key={contact.primaryEthAddress}
              >
                <ListItemText
                  primary={contact.displayName}
                  secondary={contact.primaryEthAddress}
                />
              </MenuItem>
            );
          })}
