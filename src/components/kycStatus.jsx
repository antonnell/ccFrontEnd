...
class KYC extends Component {
  ...
  render() {
    let kycIcon = <NegativeIcon style={{verticalAlign: 'bottom', marginLeft: '12px'}} />

    if(this.props.kycState == 'completed') {
      kycIcon = <PositiveIcon style={{verticalAlign: 'bottom', marginLeft: '12px'}} />
    }
    return (
      <Grid container justify="flex-start" alignItems="center" direction="row" spacing={0}  style={{marginTop: '24px'}}>
        <Grid item xs={12} sm={10} md={10} lg={10} align='left'>
          ...
          <Typography variant="body1" align='justify' style={{marginTop: '48px', fontWeight:  'bold'}}>
            Status
          </Typography>
          <Typography variant="body1" align='justify' style={{marginTop: '6px'}}>
            {this.returnStatus()}{kycIcon}
          </Typography>
        </Grid>
      </Grid>
    );
