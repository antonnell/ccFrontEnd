    ...
    return (
      <Grid container justify="space-around" direction="row" spacing={0} style={{marginTop: '100px'}}>
        <Grid item xs={10} sm={6} md={4} lg={3} >
          ...
          <Grid container justify="space-around" alignItems="center" direction="row" spacing={0} style={{marginTop: '40px'}}>
            <Grid item xs={12} align='center'>
              <Typography color="inherit" style={{fontSize: '12px', width:'80px', display: 'inline-block'}}>
                No account yet?
              </Typography>
              <Typography color="inherit" style={{fontSize: '12px', cursor: 'pointer', width: '55px', display: 'inline-block'}} onClick={this.props.submitRegisterNavigate}>
                Create one
              </Typography>
            </Grid>
          </Grid>
