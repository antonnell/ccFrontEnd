...
class Accounts extends Component {
  ...
  renderImport() {
    return (
      ...
      >
        <Grid item xs={12} align="left">
          <Typography variant="h5">Import Account</Typography>
        </Grid>
        <Grid item xs={12} sm={10} md={9} lg={7} align="left">
          <TextField
            fullWidth={true}
                ...
                <Grid item xs={9} align="left">
                  {address.editing !== true && (
                    ...
                    >
                      {address.isPrimary === true && (
                        <Tooltip
                          title={
                            "This is your primary " + address.type + " account"
                          }
                        >
                          <PrimaryIcon
                            style={{
                      ...
                      >
                        <IconButton
                          style={{ marginTop: "-8px", verticalAlign: "top" }}
                          onClick={() => {
                  ...
                  {address.editing === true && (
                    <TextField
                      ...
                      disabled={
                        this.props.cardLoading || this.props.privateKeyLoading
                      }
                      id="editAddressName"
                      ...
                      onBlur={event => {
                        this.props.onEditAddressNameBlur(event, address);
                      }}
                ...
                <Grid item xs={12}>
                  ...
                  >
                    <IconButton
                      ...
                      style={{ marginTop: "-13px", verticalAlign: "top" }}
                      onClick={() => {
                        this.props.exportKeyClicked(address.address);
                      }}
                    >
                      <KeyIcon />
                    </IconButton>
              ...
              >
                <Grid item xs={12} align="right">
                  <Button
                    ...
                    onClick={() => {
                      this.props.sendClicked(null, address);
                    }}
                  >
                    {"Send " + address.type}
                  </Button>
  ...
  render() {
    return (
      <Grid
        ...
        direction="row"
        spacing={0}
        style={{ marginTop: "0px", padding: "24px" }}
      >
        <Grid item xs={12} sm={12} md={6} lg={6} xl={8} align="left">
          <Typography variant="h5" style={{ marginBottom: "20px" }}>
            Your Accounts
          </Typography>
          <Grid container>{this.renderAddresses()}</Grid>
        </Grid>
        <Grid
          item
          xs={12}
