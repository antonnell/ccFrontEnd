...
let SendEther = createReactClass({
    ...
    return (
      <Grid container justify="center" alignItems="center" direction="row">
        <Grid
          ...
          align="left"
        >
          <PageTItle theme={this.props.theme} root={'Accounts > Ethereum'} screen={'Send'} />
        </Grid>
  ...
  selectOwnAddress(event) {
    let selectedAccount = this.props.ethAddresses.filter(address => {
  ...
  proceedClicked() {
    ...
    if (this.validateSetupPayment()) {
      ...
      completed[0] = true;
      this.setState({
        currentScreen: "confirmEthereumPayment",
        activeStep: 1,
        completed
      });
    }
  ...
  sendEtherReturned(error, data) {
    ...
    if (data.success) {
      this.setState({
        currentScreen: "completeEthereumPayment",
        activeStep: 2,
        completed,
