...
class Settings extends React.Component<Props> {
  public render() {
    const {
      name, poolId, isNameValid, ownerAddress, blockChain, handleChange, classes, ethAddresses, wanAddresses, tokenAddress, saleAddress, isSaleAddressValid, isTokenAddressValid, status,
      loading
    } = this.props;
