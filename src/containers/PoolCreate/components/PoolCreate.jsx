...
class PoolCreate extends React.Component {
        ...
        >
          ...
          <Grid item xs={12}>
            <TextField
              ...
              fullWidth
              color="textSecondary"
              error={this.props.poolNameError}
              disabled={this.props.loading}
              id="poolName"
              label="Pool Name"
              value={this.props.poolName}
              onChange={event => {
                this.props.handleChange(event, "poolName");
              }}
              margin="normal"
              onKeyDown={this.props.onLoginKeyDown}
              helperText={this.props.poolNameErrorMessage}
          ...
          <Grid item xs={5}>
            <FormControl
              error={this.props.poolSecurityError}
              fullWidth
              margin="normal"
              required
            >
              ...
              <Select
                ...
                disabled={this.props.loading}
              >
                {this.props.poolSecurities.map(security => {
                  return (
              ...
              {this.props.poolSecurityError === true ? (
                <FormHelperText>
                  {this.props.poolSecurityErrorMessage}
                </FormHelperText>
              ) : null}
            </FormControl>
          </Grid>
          <Grid item xs={5}>
            <TextField
              ...
              fullWidth
              color="textSecondary"
              error={this.props.tokenNameError}
              disabled={this.props.loading}
              id="tokenName"
              label="Token Name"
              value={this.props.tokenName}
              onChange={event => {
                this.props.handleChange(event, "tokenName");
              }}
              margin="normal"
              onKeyDown={this.props.onLoginKeyDown}
              helperText={this.props.tokenNameErrorMessage}
              InputLabelProps={{ shrink: true }}
              placeholder="Bloom"
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              fullWidth
              color="textSecondary"
              error={this.props.tokenAddressError}
              disabled={this.props.loading}
              id="tokenAddress"
              label="Token Address"
              value={this.props.tokenAddress}
              onChange={event => {
                this.props.handleChange(event, "tokenAddress");
              }}
              margin="normal"
              onKeyDown={this.props.onLoginKeyDown}
              helperText={this.props.tokenAddressErrorMessage}
              InputLabelProps={{ shrink: true }}
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={event => {
                    this.props.handleChecked(event, "pledgesEnabled");
                  }}
                  value="primary"
                  color="primary"
                />
          ...
          {this.props.pledgesEnabled ? (
            <Grid item xs={12}>
              <TextField
                ...
                fullWidth
                color="textSecondary"
                error={this.props.pledgeEndDateError}
                disabled={this.props.loading}
                id="pledgeEndDate"
                label="Pledge End Date"
                value={this.props.pledgeEndDate}
                type={"date"}
                onChange={event => {
                  this.props.handleChange(event, "pledgeEndDate");
                }}
                margin="normal"
                onKeyDown={this.props.onLoginKeyDown}
                helperText={this.props.pledgeEndDateErrorMessage}
                InputLabelProps={{ shrink: true }}
              />
            </Grid>
          ) : null}
        ...
        >
          ...
          <Grid item xs={5}>
            <TextField
              ...
              fullWidth
              color="textSecondary"
              error={this.props.contractCapError}
              disabled={this.props.loading}
              id="contractCap"
              label="Contract Cap"
              value={this.props.contractCap}
              onChange={event => {
                this.props.handleChange(event, "contractCap");
              }}
              margin="normal"
              onKeyDown={this.props.onLoginKeyDown}
              helperText={this.props.contractCapErrorMessage}
              InputLabelProps={{ shrink: true }}
          ...
          <Grid item xs={5}>
            <TextField
              ...
              fullWidth
              color="textSecondary"
              error={this.props.yourFeeError}
              disabled={this.props.loading}
              id="yourFee"
              label="Your Fee"
              value={this.props.yourFee}
              onChange={event => {
                this.props.handleChange(event, "yourFee");
              }}
              margin="normal"
              onKeyDown={this.props.onLoginKeyDown}
              helperText={this.props.yourFeeErrorMessage}
              InputLabelProps={{ shrink: true }}
              placeholder="5%"
            />
          </Grid>
          <Grid item xs={5}>
            <TextField
              ...
              fullWidth
              color="textSecondary"
              error={this.props.minCapError}
              disabled={this.props.loading}
              id="minCap"
              label="Min-Cap"
              value={this.props.minCap}
              onChange={event => {
                this.props.handleChange(event, "minCap");
              }}
              margin="normal"
              onKeyDown={this.props.onLoginKeyDown}
              helperText={this.props.minCapErrorMessage}
              InputLabelProps={{ shrink: true }}
              placeholder="10 WAN"
            />
          </Grid>
          <Grid item xs={5}>
            <TextField
              ...
              fullWidth
              color="textSecondary"
              error={this.props.maxCapError}
              disabled={this.props.loading}
              id="maxCap"
              label="Max-Cap"
              value={this.props.maxCap}
              onChange={event => {
                this.props.handleChange(event, "maxCap");
              }}
              margin="normal"
              onKeyDown={this.props.onLoginKeyDown}
              helperText={this.props.maxCapErrorMessage}
              InputLabelProps={{ shrink: true }}
              placeholder="25 WAN"
            />
          </Grid>
        ...
        >
          ...
          <Grid item xs={8}>
            <TextField
              ...
              fullWidth
              color="textSecondary"
              error={this.props.searchUserError}
              disabled={this.props.loading}
              id="searchUser"
              label="Search User"
              value={this.props.searchUser}
              onChange={event => {
                this.props.handleChange(event, "searchUser");
              }}
              margin="normal"
              onKeyDown={this.props.onLoginKeyDown}
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Grid item xs={8}>
            <FormControl
              error={this.props.chooseListError}
              fullWidth
              margin="normal"
              required
            >
              ...
              {this.props.chooseListError === true ? (
                <FormHelperText>
                  {this.props.chooseListErrorMessage}
                </FormHelperText>
              ) : null}
            </FormControl>
          </Grid>
  ...
  renderChips() {
    ...
    return this.props.addedUsers.map((user, i) => {
      return (
        <Chip
          key={i}
          label={user}
      ...
      >
        ...
        <Grid item xs={12} align={"right"} style={{ margin: "12px" }}>
          <Button
            ...
            size="large"
            color="primary"
            onClick={this.props.submitLaunchPool}
            disabled={this.props.loading}
          >
            LAUNCH POOL
          </Button>
