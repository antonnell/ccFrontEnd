...
var Store = () => {
  ...
  this.getUserCrowdSaleContributions = function(payload) {
    var url = 'crowdsale/getUserCrowdSaleContributions/'+payload.content.userId+'/'+payload.content.crowdsaleID
  ...
  this.refund = function(payload) {
    let url = 'crowdsale/refund'

    var postJson = {
      saleId: payload.content.saleId,
      address: payload.content.address,
      tokenCount: payload.content.tokenCount,
    }
